...
LFLAGS=-L/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/lib/python3.12/site-packages/torch/lib -lc10 -ltorch -ltorch_cpu -ltorch_python 
...
includes=-I/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/lib/python3.12/site-packages/torch/include -I/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/lib/python3.12/site-packages/torch/include/torch/csrc/api/include -I/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/lib/python3.12/site-packages/torch/include/TH -I/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/lib/python3.12/site-packages/torch/include/THC -I/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/include -I/usr/include/python3.12 


all: $(dir)/causal_product_numerator_cpu.cpython-312-x86_64-linux-gnu.so $(dir)/causal_product_numerator_cuda.cpython-312-x86_64-linux-gnu.so


$(dir)/causal_product_%_cuda.cpython-312-x86_64-linux-gnu.so: $(dir)/causal_product_%_cuda.o 
	x86_64-linux-gnu-g++ -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-Bsymbolic-functions -Wl,-z,relro -g -fwrapv -O2 $^ -L/home/anthon@ad.cmm.se/projects/dataintegration/pyenv/lib/python3.12/site-packages/torch/lib -L/usr/local/cuda-12.2/lib64 -L/usr/lib/x86_64-linux-gnu -lc10 -ltorch -ltorch_cpu -ltorch_python -lcudart -lc10_cuda -ltorch_cuda -o $@
